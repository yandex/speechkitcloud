...
this.close=function(){socket.close();}};window.webspeechkit.Dictation=function(asr_url,uuid,apikey){var backref=this;backref.send=0;backref.send_bytes=0;backref.proc=0;backref.bufsize=1024;backref.webSocketPath=function(){if(asr_url.startsWith("wss://")||asr_url.startsWith("ws://"))
